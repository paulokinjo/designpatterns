namespace TemplateMethod
{
    ...
    {
        internal abstract class MailParser
        {
        ...
        internal class ExchangeMailParser : MailParser
        {
        ...
        internal class ApacheMailParser : MailParser
        {
            public override void AuthenticateToServer()
            {
        ...
        internal class EudoraMailParser : MailParser
        {
